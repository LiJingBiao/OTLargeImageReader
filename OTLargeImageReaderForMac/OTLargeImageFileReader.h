 ...
 */
+ (NSImage *)thumbImageFromLargeFile:(NSString *)filePath withMaxPixelSize:(CGFloat)maxPixelSize imageSize:(CGSize)imageSize;
 ...
 */
+ (void)thumbImageFromLargeFile:(NSString *)filePath withMaxPixelSize:(CGFloat)maxPixelSize imageSize:(CGSize)imageSize callback:(void(^)(NSImage *))callback;
 ...
 *  @return The result thumbnail. Nil if generate thumbnail failed.
 */
+ (NSImage *)thumbImageFromLargeFile:(NSString *)filePath withMinPixelSize:(CGFloat)minPixelSize imageSize:(CGSize)imageSize;
 ...
 *  @param callback     The callback of result image. Pass nil if generate thumbnail failed.
 */
+ (void)thumbImageFromLargeFile:(NSString *)filePath withMinPixelSize:(CGFloat)minPixelSize imageSize:(CGSize)imageSize callback:(void(^)(NSImage *))callback;
